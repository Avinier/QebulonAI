...
const DashboardPage = () => {
  ...
  const instances = [
    ...
    {
      title: "nk-coaltrack",
      domain: "nkcoaltrack.com",
      repoPath: "Sinha-Aditya/coaltracker",
      lastCommit: "wait",
      timeAgo: "1d ago",
      branch: "main",
      icon: "/logo-1.jpeg",
    ...
    {
      title: "qebulon-models",
      domain: "quantumsenses.com",
      repoPath: "Qebulon-Org/HF-Models",
      lastCommit: "wait",
      timeAgo: "1d ago",
      branch: "main",
      icon: "/logo-1.jpeg",
    ...
    {
      title: "nmims-timetable-sys",
      domain: "quantumsenses.com",
      repoPath: "NMIMS/timetable",
      lastCommit: "wait",
      timeAgo: "1d ago",
      branch: "main",
      icon: "/logo-1.jpeg",
